...
+ (int)isSeparatable:(NSString *)str {
    if ((([str compare:@"a"] == NSOrderedDescending || [str compare:@"a"] == NSOrderedSame) && ([str compare:@"z"] == NSOrderedAscending || [str compare:@"z"] == NSOrderedSame)) || (([str compare:@"A"] == NSOrderedDescending || ([str compare:@"A"] == NSOrderedSame)) && ([str compare:@"Z"] == NSOrderedAscending || [str compare:@"Z"] == NSOrderedSame))) {
        return 1;
    }
    if ([str compare:@"."] == NSOrderedSame || [str compare:@"。"] == NSOrderedSame || [str compare:@","] == NSOrderedSame || [str compare:@"，"] == NSOrderedSame || [str compare:@"?"] == NSOrderedSame || [str compare:@"？"] == NSOrderedSame || [str compare:@"!"] == NSOrderedSame || [str compare:@"！"] == NSOrderedSame || [str compare:@")"] == NSOrderedSame || [str compare:@"）"] == NSOrderedSame || [str compare:@"]"] == NSOrderedSame || [str compare:@"］"] == NSOrderedSame || [str compare:@"}"] == NSOrderedSame || [str compare:@"｝"] == NSOrderedSame || [str compare:@">"] == NSOrderedSame || [str compare:@"》"] == NSOrderedSame || [str compare:@"%"] == NSOrderedSame || [str compare:@"％"] == NSOrderedSame) {
        return 2;
    }
